					...
					$.post(url, function(data) {
						...
						for ( var i = 0; i < list.length; i++) {
							...
							$div.last().last().find("div").addClass(
									"panel-body");
							$divBlock = 	$div.last().last().find("div");
							
							$divBlock.append("<div class='alert alert-info dish-inner' role='alert'>描述："+list[i].description+"</div>");
							...
							$div.append("<div class='panel-footer'></div>");
					...
					<div class="panel panel-default book-dish">
						<div class="panel-body">
							...
							<img src="upload/${dish.picture }" class="img-rounded"
								...
								class="dish-name">开胃萝卜酸</b>
							<p>
								销量：200 库存：500 <br> 价格：10.0<strong><font
